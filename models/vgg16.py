...
class Vgg16(CNNs):
    ...
    def create(self):
        ...
        self.pool3_1 = self.pool(self.conv3_3, 2, 2, 2, 2, 'b3_pool1', 'SAME')
        ...
        self.pool4_1 = self.pool(self.conv4_3, 2, 2, 2, 2, 'b4_pool1', 'SAME')
        ...
        self.pool5_1 = self.pool(self.conv5_3, 2, 2, 2, 2,  'b5_pool1', 'SAME')
